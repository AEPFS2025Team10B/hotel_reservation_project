...
INSERT INTO Booking(guest_id, room_id, check_in_date, check_out_date, is_cancelled, total_amount, rating, recommendation) VALUES
  -- Original 5 bookings
  (1, 1, date('now', '-2 days'), date('now', '+2 days'), 0, 240.0, NULL, NULL),
  (2, 2, date('now', '-2 days'), date('now', '+2 days'), 0, 300.0, 7, NULL),
  (3, 3, date('now', '-2 days'), date('now', '+2 days'), 0, 260.0, 10, 'Best hotel experience ever!'),
  (4, 4, date('now', '-2 days'), date('now', '+2 days'), 1, 280.0, NULL, NULL),
  (5, 5, date('now', '-2 days'), date('now', '+2 days'), 0, 320.0, 6, 'Good but could be better.'),
  
  -- Second bookings for first 5 guests (rooms 1-5)
  (1, 1, date('now', '-2 days'), date('now', '+2 days'), 0, 240.0, 9, 'Excellent service and beautiful rooms!'),
  (2, 2, date('now', '-2 days'), date('now', '+2 days'), 0, 300.0, 7, NULL),
  (3, 3, date('now', '-2 days'), date('now', '+2 days'), 0, 260.0, 10, 'Best hotel experience ever!'),
  (4, 4, date('now', '-2 days'), date('now', '+2 days'), 0, 280.0, 8, 'Great stay'),
  (5, 5, date('now', '-2 days'), date('now', '+2 days'), 0, 320.0, 6, 'Good but could be better.'),
  
  -- New bookings for all 80 guests
  (6, 6, date('now', '-2 days'), date('now', '+2 days'), 0, 240.0, 8, 'Very comfortable stay'),
  (7, 7, date('now', '-2 days'), date('now', '+2 days'), 0, 300.0, 9, 'Great location'),
  (8, 8, date('now', '-2 days'), date('now', '+2 days'), 0, 260.0, 7, NULL),
  (9, 9, date('now', '-2 days'), date('now', '+2 days'), 0, 280.0, 10, 'Perfect service'),
  (10, 10, date('now', '-2 days'), date('now', '+2 days'), 0, 320.0, 8, 'Would come again'),
  (11, 11, date('now', '-2 days'), date('now', '+2 days'), 0, 240.0, 9, 'Excellent experience'),
  (12, 12, date('now', '-2 days'), date('now', '+2 days'), 0, 300.0, 7, 'Nice hotel'),
  (13, 13, date('now', '-2 days'), date('now', '+2 days'), 0, 260.0, 8, 'Good value'),
  (14, 14, date('now', '-2 days'), date('now', '+2 days'), 0, 280.0, 9, 'Great staff'),
  (15, 15, date('now', '-2 days'), date('now', '+2 days'), 0, 320.0, 10, 'Best hotel ever'),
  (16, 16, date('now', '-2 days'), date('now', '+2 days'), 0, 240.0, 8, 'Comfortable rooms'),
  (17, 17, date('now', '-2 days'), date('now', '+2 days'), 0, 300.0, 7, NULL),
  (18, 18, date('now', '-2 days'), date('now', '+2 days'), 0, 260.0, 9, 'Excellent service'),
  (19, 19, date('now', '-2 days'), date('now', '+2 days'), 0, 280.0, 8, 'Great location'),
  (20, 20, date('now', '-2 days'), date('now', '+2 days'), 0, 320.0, 10, 'Perfect stay'),
  (21, 21, date('now', '-2 days'), date('now', '+2 days'), 0, 240.0, 7, 'Nice hotel'),
  (22, 22, date('now', '-2 days'), date('now', '+2 days'), 0, 300.0, 9, 'Would recommend'),
  (23, 23, date('now', '-2 days'), date('now', '+2 days'), 0, 260.0, 8, 'Great experience'),
  (24, 24, date('now', '-2 days'), date('now', '+2 days'), 0, 280.0, 10, 'Best service'),
  (25, 25, date('now', '-2 days'), date('now', '+2 days'), 0, 320.0, 7, NULL),
  (26, 26, date('now', '-2 days'), date('now', '+2 days'), 0, 240.0, 9, 'Excellent stay'),
  (27, 27, date('now', '-2 days'), date('now', '+2 days'), 0, 300.0, 8, 'Great hotel'),
  (28, 28, date('now', '-2 days'), date('now', '+2 days'), 0, 260.0, 10, 'Perfect experience'),
  (29, 29, date('now', '-2 days'), date('now', '+2 days'), 0, 280.0, 7, 'Nice staff'),
  (30, 30, date('now', '-2 days'), date('now', '+2 days'), 0, 320.0, 9, 'Would come again'),
  (31, 31, date('now', '-2 days'), date('now', '+2 days'), 0, 240.0, 8, 'Great location'),
  (32, 32, date('now', '-2 days'), date('now', '+2 days'), 0, 300.0, 10, 'Best hotel'),
  (33, 33, date('now', '-2 days'), date('now', '+2 days'), 0, 260.0, 7, NULL),
  (34, 34, date('now', '-2 days'), date('now', '+2 days'), 0, 280.0, 9, 'Excellent service'),
  (35, 35, date('now', '-2 days'), date('now', '+2 days'), 0, 320.0, 8, 'Great stay'),
  (36, 36, date('now', '-2 days'), date('now', '+2 days'), 0, 240.0, 10, 'Perfect experience'),
  (37, 37, date('now', '-2 days'), date('now', '+2 days'), 0, 300.0, 7, 'Nice hotel'),
  (38, 38, date('now', '-2 days'), date('now', '+2 days'), 0, 260.0, 9, 'Would recommend'),
  (39, 39, date('now', '-2 days'), date('now', '+2 days'), 0, 280.0, 8, 'Great service'),
  (40, 40, date('now', '-2 days'), date('now', '+2 days'), 0, 320.0, 10, 'Best stay ever'),
  (41, 41, date('now', '-2 days'), date('now', '+2 days'), 0, 240.0, 7, NULL),
  (42, 42, date('now', '-2 days'), date('now', '+2 days'), 0, 300.0, 9, 'Excellent hotel'),
  (43, 43, date('now', '-2 days'), date('now', '+2 days'), 0, 260.0, 8, 'Great location'),
  (44, 44, date('now', '-2 days'), date('now', '+2 days'), 0, 280.0, 10, 'Perfect service'),
  (45, 45, date('now', '-2 days'), date('now', '+2 days'), 0, 320.0, 7, 'Nice stay'),
  (46, 46, date('now', '-2 days'), date('now', '+2 days'), 0, 240.0, 9, 'Would come again'),
  (47, 47, date('now', '-2 days'), date('now', '+2 days'), 0, 300.0, 8, 'Great experience'),
  (48, 48, date('now', '-2 days'), date('now', '+2 days'), 0, 260.0, 10, 'Best hotel'),
  (49, 49, date('now', '-2 days'), date('now', '+2 days'), 0, 280.0, 7, NULL),
  (50, 50, date('now', '-2 days'), date('now', '+2 days'), 0, 320.0, NULL, NULL),
  (51, 51, date('now', '-2 days'), date('now', '+2 days'), 0, 240.0, NULL, NULL),
  (52, 52, date('now', '-2 days'), date('now', '+2 days'), 0, 300.0, NULL, NULL),
  (53, 53, date('now', '-2 days'), date('now', '+2 days'), 0, 260.0, NULL, NULL),
  (54, 54, date('now', '-2 days'), date('now', '+2 days'), 0, 280.0, NULL, NULL),
  (55, 55, date('now', '-2 days'), date('now', '+2 days'), 0, 320.0, NULL, NULL),
  (56, 56, date('now', '-2 days'), date('now', '+2 days'), 0, 240.0, NULL, NULL),
  (57, 57, date('now', '-2 days'), date('now', '+2 days'), 0, 300.0, NULL, NULL),
  (58, 58, date('now', '-2 days'), date('now', '+2 days'), 0, 260.0, NULL, NULL),
  (59, 59, date('now', '-2 days'), date('now', '+2 days'), 0, 280.0, 8, 'Great location'),
  (60, 60, date('now', '-2 days'), date('now', '+2 days'), 0, 320.0, 10, 'Perfect service'),
  (61, 61, date('now', '-2 days'), date('now', '+2 days'), 0, 240.0, 7, 'Nice stay'),
  (62, 62, date('now', '-2 days'), date('now', '+2 days'), 0, 300.0, 9, 'Would come again'),
  (63, 63, date('now', '-2 days'), date('now', '+2 days'), 0, 260.0, 8, 'Great experience'),
  (64, 64, date('now', '-2 days'), date('now', '+2 days'), 0, 280.0, 10, 'Best hotel'),
  (65, 65, date('now', '-2 days'), date('now', '+2 days'), 0, 320.0, 7, NULL),
  (66, 66, date('now', '-2 days'), date('now', '+2 days'), 0, 240.0, 9, 'Excellent service'),
  (67, 67, date('now', '-2 days'), date('now', '+2 days'), 0, 300.0, 8, 'Great stay'),
  (68, 68, date('now', '-2 days'), date('now', '+2 days'), 0, 260.0, 10, 'Perfect experience'),
  (69, 69, date('now', '-2 days'), date('now', '+2 days'), 0, 280.0, 7, 'Nice hotel'),
  (70, 70, date('now', '-2 days'), date('now', '+2 days'), 0, 320.0, 9, 'Would recommend'),
  (71, 71, date('now', '-2 days'), date('now', '+2 days'), 0, 240.0, 8, 'Great service'),
  (72, 72, date('now', '-2 days'), date('now', '+2 days'), 0, 300.0, 10, 'Best stay ever'),
  (73, 73, date('now', '-2 days'), date('now', '+2 days'), 0, 260.0, 7, NULL),
  (74, 74, date('now', '-2 days'), date('now', '+2 days'), 0, 280.0, 9, 'Excellent hotel'),
  (75, 75, date('now', '-2 days'), date('now', '+2 days'), 0, 320.0, 8, 'Great location'),
  (76, 76, date('now', '-2 days'), date('now', '+2 days'), 0, 240.0, 10, 'Perfect service'),
  (77, 77, date('now', '-2 days'), date('now', '+2 days'), 0, 300.0, 7, 'Nice stay'),
  (78, 78, date('now', '-2 days'), date('now', '+2 days'), 0, 260.0, 9, 'Would come again'),
  (79, 79, date('now', '-2 days'), date('now', '+2 days'), 0, 280.0, 8, 'Great experience'),
  (80, 80, date('now', '-2 days'), date('now', '+2 days'), 0, 320.0, 10, 'Best hotel');
...
"""
    ...
    conn.commit()
    conn.close()
    print("✅ The databank got manipulate, you can now check search_all_hotel_details.py now.")
