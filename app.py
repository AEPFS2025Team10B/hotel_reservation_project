...
def main():
    ...
    while is_in_use:
        ...
        try:
            choice = int(input("Enter number you want to run (99 to exit): "))
        except ValueError:
            print("Invalid input pleas enter a nuber displayed.")
            continue
        ...
        if choice == 0:
            ...
            if match:
                ...
                print("Invalid choice, pleas enter a nuber displayed or 99 to exit")
